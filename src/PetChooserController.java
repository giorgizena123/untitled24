...
public class PetChooserController {
    ...
    private void choosePet() {
        ...
        if (selectedRadioButton != null) {
            ...
            if (!petName.isEmpty()) {
                resultLabel.setText("შენ აირჩიე " + selectedPet + " სახელად " + petName);
            } else {
                resultLabel.setText("შეიყვანეთ თქვენი შინაური ცხოველის სახელი.");
            }
        } else {
            resultLabel.setText("აირჩიეთ შინაური ცხოველი.");
        }
    }
}
